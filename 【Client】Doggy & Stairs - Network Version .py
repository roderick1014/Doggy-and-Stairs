...
class PlayWindow(Canvas):
   ...
   def LoadImages(self):
      ...
      Constants.DogIm[0] =tk.PhotoImage(file='Doggy2.png')
      Constants.DogIm[1] = tk.PhotoImage(file='Doggy2-Left1.png')
      Constants.DogIm[2] = tk.PhotoImage(file='Doggy2-Left2.png')
      Constants.DogIm[3] = tk.PhotoImage(file='Doggy2-Left.png') 
      Constants.DogIm[4] = tk.PhotoImage(file='Doggy2-2.png') 
      Constants.DogIm[5] = tk.PhotoImage(file='Doggy2-Right1.png') 
      Constants.DogIm[6] = tk.PhotoImage(file='Doggy2-Right2.png')
      Constants.DogIm[7] = tk.PhotoImage(file='Doggy2-Right.png') 

      Constants.HurtDogIm[0] = tk.PhotoImage(file='Doggy2H.png')
      Constants.HurtDogIm[1] = tk.PhotoImage(file='Doggy2_Left1H.png')
      Constants.HurtDogIm[2] = tk.PhotoImage(file='Doggy2_Left2H.png') 
      Constants.HurtDogIm[3] = tk.PhotoImage(file='Doggy2_LeftH.png')
      Constants.HurtDogIm[4] = tk.PhotoImage(file='Doggy2-2H.png')
      Constants.HurtDogIm[5] = tk.PhotoImage(file='Doggy2_Right1H.png')
      Constants.HurtDogIm[6] = tk.PhotoImage(file='Doggy2_Right2H.png')
      Constants.HurtDogIm[7] = tk.PhotoImage(file='Doggy2_RightH.png')


      Constants.Dog2Im[0] = tk.PhotoImage(file='Doggy1.png') 
      Constants.Dog2Im[1] = tk.PhotoImage(file='Doggy1-Left1.png')
      Constants.Dog2Im[2] = tk.PhotoImage(file='Doggy1-Left2.png')
      Constants.Dog2Im[3] = tk.PhotoImage(file='Doggy1-Left.png')
      Constants.Dog2Im[4] = tk.PhotoImage(file='Doggy1-2.png')
      Constants.Dog2Im[5] =  tk.PhotoImage(file='Doggy1-Right1.png')
      Constants.Dog2Im[6] = tk.PhotoImage(file='Doggy1-Right2.png')
      Constants.Dog2Im[7] = tk.PhotoImage(file='Doggy1-Right.png')

      Constants.HurtDog2Im[0] = tk.PhotoImage(file='Doggy1H.png')
      Constants.HurtDog2Im[1] = tk.PhotoImage(file='Doggy1_Left1H.png')
      Constants.HurtDog2Im[2] = tk.PhotoImage(file='Doggy1_Left2H.png') 
      Constants.HurtDog2Im[3] = tk.PhotoImage(file='Doggy1_LeftH.png')
      Constants.HurtDog2Im[4] = tk.PhotoImage(file='Doggy1-2H.png')
      Constants.HurtDog2Im[5] = tk.PhotoImage(file='Doggy1_Right1H.png')
      Constants.HurtDog2Im[6] = tk.PhotoImage(file='Doggy1_Right2H.png')
      Constants.HurtDog2Im[7] = tk.PhotoImage(file='Doggy1_RightH.png')
